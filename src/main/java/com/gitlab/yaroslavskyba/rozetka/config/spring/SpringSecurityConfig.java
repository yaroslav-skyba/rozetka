...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
            ...
            .antMatchers(HttpMethod.POST, ControllerPath.PRODUCTS, ControllerPath.USERS, ControllerPath.ROLE).hasAuthority(ADMIN)
            .antMatchers(HttpMethod.GET, ControllerPath.USERS).hasAuthority(ADMIN)
            .antMatchers(HttpMethod.PUT, ControllerPath.PRODUCTS, ControllerPath.REVIEWS, ControllerPath.ROLE).hasAuthority(ADMIN)
            ...
            .antMatchers(HttpMethod.PUT, ControllerPath.USERS).hasAnyAuthority(ADMIN, USER)
